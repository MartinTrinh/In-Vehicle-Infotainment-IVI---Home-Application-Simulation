...
#include <memory>
#include "../HomeScreenAutomotive/src/controller/applicationcontroller.h"
...
QT_MOC_LITERAL(1, 22, 12), // "modelChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 17), // "updateDataFromQML"
QT_MOC_LITERAL(4, 54, 4), // "from"
QT_MOC_LITERAL(5, 59, 2) // "to"

    },
    "ApplicationController\0modelChanged\0\0"
    "updateDataFromQML\0from\0to"
};
...
void ApplicationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateDataFromQML((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ApplicationController::modelChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ApplicationController::modelChanged()
{
